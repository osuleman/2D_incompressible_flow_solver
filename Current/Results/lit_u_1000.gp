...
set x2range [ * : * ] noreverse nowriteback  # (currently [-0.382890:1.00000] )
set ylabel "y/L_{ref}" 
...
GNUTERM = "wxt"
plot "./Ghia_et.al./GhiaEtAl-uy-Re1000.dat" using 2:1 title "Ghia et. al." with points, "./Sim1/Re1000/N129/Suleman-uy-Re01000-0129x0129.dat" using 2:1 title "Grid:129x129" with points
#    EOF
