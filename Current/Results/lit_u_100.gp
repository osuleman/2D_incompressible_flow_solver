...
set x2range [ * : * ] noreverse nowriteback  # (currently [-0.213431:1.00000] )
set ylabel "y/L_{ref}" 
...
GNUTERM = "wxt"
plot "./Ghia_et.al./GhiaEtAl-uy-Re100.dat" using 2:1 title "Ghia et. al." with points, "./Sim1/Re100/N129/Suleman-uy-Re0100-0129x0129.dat" using 2:1 title "Grid:129x129" with points
#    EOF
